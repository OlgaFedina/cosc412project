package com.example.chatbot_v1;
...
import com.example.chatbot_v1.Adapter.ChatMessageAdapter;
import com.example.chatbot_v1.Model.ChatMessage;
            ...
            try{
                ...
                for(String dir : assets.list("TBC/")){
                    ...
                    for (String file : assets.list("TBC/" + dir)){
                        ...
                        //copy files form assets to the mobile's SD card or any secondary memory available
